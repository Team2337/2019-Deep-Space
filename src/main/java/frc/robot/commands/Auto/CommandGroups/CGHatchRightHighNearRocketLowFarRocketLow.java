 ...
 * @author Bryce G.
 */
public class CGHatchRightHighNearRocketLowFarRocketLow extends CommandGroup {
  double[][] valuesPID = pathway.valuesPID;

  public CGHatchRightHighNearRocketLowFarRocketLow() {
    
    addSequential(new CommonHighRightToNearRocketLowFast());
