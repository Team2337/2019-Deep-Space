 ...
 * @author Bryce G.
 */
public class CGTractionHatchLeftHighNearRocketLowFarRocketLow extends CommandGroup {
  double[][] valuesPID = pathway.valuesPID;

  public CGTractionHatchLeftHighNearRocketLowFarRocketLow() {
    
    addSequential(new CommonTractionHighLeftToNearRocket());
    addSequential(new CommonTractionLeftLoadToFarRocketLowFast());
