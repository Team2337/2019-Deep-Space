 ...
 * @author Bryce G.
 */
public class CGTractionHatchRightHighNearRocketLowFarRocketLow extends CommandGroup {
  double[][] valuesPID = pathway.valuesPID;

  public CGTractionHatchRightHighNearRocketLowFarRocketLow() {
    
    addSequential(new CommonTractionHighRightToNearRocketLow());
    addSequential(new CommonTractionRightLoadToFarRocketLowFast());
