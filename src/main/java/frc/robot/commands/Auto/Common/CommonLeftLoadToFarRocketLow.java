 ...
 * @author Bryce G.
 */
public class CommonLeftLoadToFarRocketLow extends CommandGroup {
  public CommonLeftLoadToFarRocketLow() {
    ...
    addSequential(new autoTankDrive(-0.65, -0.58, 155000, 0, "left", IdleMode.kCoast));
    addSequential(new autoTankDrive(0.32, -0.27, 0, 163000, "right", IdleMode.kBrake));
