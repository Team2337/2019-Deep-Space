 ...
 * @author Bryce G.
 */
public class autoPIDVisionDriveOmni extends PIDCommand {
   ...
   * 
   * @param timeout        - how long (in seconds) the command should run for (in
   *                       the event the command has not ended otherwise)
   ...
   */
  public autoPIDVisionDriveOmni(double timeout, double smallAngleP, double largeAngleP, double maxSpeed) {
    ...
    getPIDController().setOutputRange(-0.24, 0.24);       // output range for 'turn' input to drive command    had at .3%
