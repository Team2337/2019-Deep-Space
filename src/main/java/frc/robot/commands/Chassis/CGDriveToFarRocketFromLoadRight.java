...
public class CGDriveToFarRocketFromLoadRight extends CommandGroup {
  public CGDriveToFarRocketFromLoadRight() {
    ...
    addSequential(new autoTankDrive(-0.7, -0.61, 60000, 0, "left", IdleMode.kCoast));
    addSequential(new autoTankDrive(-0.61, -0.75, 0, 110000, "right", IdleMode.kCoast));
    addSequential(new autoTankDrive(-0.45, -0.65, 0, 155000, "right", IdleMode.kCoast));
